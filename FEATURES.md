...
- Search and filter items by name with dynamic light yellow/amber background highlight feedback when search text is active, and an enlarged clear button (22px font size with 36x36px touch/hover target).

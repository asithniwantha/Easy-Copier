...
- Resolved NuGet warning NU1504 in CI builds by removing a duplicate `Microsoft.Extensions.Logging.Console` `PackageReference` entry from `Easy Copier/Easy Copier.csproj` and sorting PackageReferences alphabetically.
